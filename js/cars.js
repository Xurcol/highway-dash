...
import { REAL_BODIES } from "./bodies-real.js?v=muew3v7x";
import { loftBody, loftGreenhouse, tireGeo, contactShadow, bodySpan, bodyTop, frontAt, rearAt } from "./carmesh.js?v=muew3v7x";
...
export const CARS = [
  ...
  { id: "c43", name: "Mercedes-AMG C43", rarity: "COMMON", price: 0, body: "c43", color: 0xf1f1f1, handling: 71, sound: "m264",
    spec: spec({ hp: 402, torque: 500, mass: 1765, ratios: [5.35, 3.24, 2.25, 1.64, 1.21, 1, .87, .72, .6], final: 2.65, redline: 6300, idle: 700, cda: .6, grip: .98, tire: .33, shiftTime: .1, vmax: 209 }) },
  // ---- real cars ----
  ...
  { id: "m2", name: "BMW M2 (G87)", rarity: "LEGENDARY", price: 4800, body: "m2", color: 0x3b7dd8, handling: 83, sound: "s58",
  ...
  { id: "m3", name: "BMW M3 Competition (G80)", rarity: "LEGENDARY", price: 6800, body: "m3", color: 0x5a8a2b, handling: 84, sound: "s58",
    spec: bmw8({ hp: 503, torque: 650, mass: 1730, redline: 7200, idle: 800, cda: .66, grip: 1.08, shiftTime: .08, vmax: 290 }) },
  { id: "charger", name: "Dodge Charger SRT Hellcat", rarity: "LEGENDARY", price: 7400, body: "charger", color: 0x6d1f1f, handling: 64, sound: "hellcat",
    spec: spec({ hp: 707, torque: 881, mass: 2073, ratios: ZF8, final: 2.62, redline: 6200, idle: 700, cda: .78, grip: .96, tire: .36, shiftTime: .12, vmax: 328 }) },
  { id: "carrera", name: "Porsche 911 Carrera 4S", rarity: "LEGENDARY", price: 8600, body: "carrera", color: 0xb8bcc2, handling: 89, sound: "f6",
    spec: spec({ hp: 443, torque: 530, mass: 1565, ratios: HP8, final: 3.59, redline: 7500, idle: 800, cda: .58, grip: 1.12, tire: .34, shiftTime: .06, vmax: 306 }) },
  ...
  { id: "m4", name: "BMW M4 Competition (G82)", rarity: "LEGENDARY", price: 7000, body: "m4", color: 0xf2c200, handling: 85, sound: "s58",
  ...
  { id: "chiron", name: "Bugatti Chiron", rarity: "MYTHIC", price: 40000, body: "svj", color: 0x1c3f94, handling: 88, sound: "w16",
    spec: spec({ hp: 1479, torque: 1600, mass: 1995, ratios: [3.909, 2.438, 1.81, 1.458, 1.185, .967, .844], final: 3.2, redline: 7100, idle: 800, cda: .74, grip: 1.2, tire: .38, shiftTime: .06 }) },
