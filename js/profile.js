...
import { store } from "./net.js?v=muew3v7x";
import { CARS, specOf } from "./cars.js?v=muew3v7x";
import { normalizeTune, defaultTune, audioConfig, PARTS } from "./tuning.js?v=muew3v7x";
import { carPrice, partPrice, TUNING_PRICES, COSMETIC_PRICES, stylePrice, FITMENT_KEYS } from "./economy.js?v=muew3v7x";
...
const DEFAULTS = {
  ...
  settings: { hour: 18.6, flow: false, sky: "Aurora", weather: "Clear", traffic: "Heavy", volMaster: .8, volEngine: .9, volFx: .9, volWind: .35, driveMode: "sport", manual: false, shadows: true, bloom: true, res: 1, scenery: 1, viewDist: 1, nightLights: 1, gfx: -1, cinematic: false, customCam: { dist: 9, height: 3.4, pitch: 4, fov: 60 }, hideNames: false },
};
...
export const carStyle = (id) => ({ finish: "gloss", tint: "dark", lightTint: false, stance: "stock", rim: null, caliper: null, glow: null, flame: null, drop: null, offset: 0, camber: 0, wsize: 1, ...(P.styles?.[id] || {}) });
