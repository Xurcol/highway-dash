...
import { EngineDSP, burbleIntensity, DEFAULT_TUNE } from "./engine-dsp.js?v=muew3v7x";
...
export class AudioManager {
  ...
  async init() {
    ...
    try {
      await ctx.audioWorklet.addModule(new URL("./engine-worklet.js?v=muew3v7x", import.meta.url));
      this.worklet = true;
