...
import { EngineDSP, burbleIntensity, DEFAULT_TUNE } from "./engine-dsp.js?v=mu6adgwj";
...
export class AudioManager {
  ...
  async init() {
    ...
    try {
      await ctx.audioWorklet.addModule(new URL("./engine-worklet.js?v=mu6adgwj", import.meta.url));
      this.worklet = true;
