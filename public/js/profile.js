...
const DEFAULTS = {
  ...
  settings: { hour: 18.6, flow: false, sky: "Aurora", weather: "Clear", traffic: "Heavy", volMaster: .8, volEngine: .9, volFx: .9, volWind: .35, driveMode: "sport", manual: false, shadows: true, bloom: true, res: 1, scenery: 1, viewDist: 1, nightLights: 1, customCam: { dist: 9, height: 3.4, pitch: 4, fov: 60 }, hideNames: false },
};
